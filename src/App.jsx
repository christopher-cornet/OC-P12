...
import projet11 from "../src/assets/projet11.webp";
import projet10 from "../src/assets/projet10.webp";
import projet8 from "../src/assets/projet8.webp";
import projet6 from "../src/assets/projet6.webp";
        ...
        <GlowCapture>
          <Glow color='hsl(48, 96%, 53%)'>
            <div className="projects">
              <Card projectPath={projet11} title="Argent Bank" repository="https://github.com/christopher-cornet/OC-P11" website="" alt="Projet 11 Argent Bank" />
              <Card projectPath={projet10} title="724 Events" repository="https://github.com/christopher-cornet/OC-P10" website="" alt="Projet 10 724 Events" />
              <Card projectPath={projet8} title="Kasa" repository="https://github.com/christopher-cornet/oc-kasa" website="" alt="Projet 8 Kasa" />
              <Card projectPath={projet6} title="Portfolio d'architecte" repository="https://github.com/christopher-cornet/oc-portfolio-architecte" website="" alt="Projet Portfolio d'architecte" />
              <Card projectPath={projet5} title="Print-it" repository="https://github.com/christopher-cornet/print-it" website="https://christopher-cornet.github.io/print-it/" alt="Projet Print It" />
              <Card projectPath={projet4} title="Oh My Food" repository="https://github.com/christopher-cornet/ohmyfood" website="https://christopher-cornet.github.io/ohmyfood/" alt="Projet Oh My Food" />
            </div>
          </Glow>
        </GlowCapture>
        {/* Skills */}
